...
public class CustomRatingView extends ViewGroup {
    public static final int STAR_EMPTY = R.drawable.ic_staroff;
    public static final int STAR_HALF = R.drawable.ic_staron;
    public static final int STAR_FULL = R.drawable.ic_staron;
    ...
    private ImageView createChild() {
        ...
        imageView.setImageResource(R.drawable.ic_staroff);
    ...
    public interface OnStarChangeListener {
        void onStarChange(CustomRatingView ratingBar, float star);
    }
